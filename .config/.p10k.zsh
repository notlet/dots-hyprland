# Generated by Powerlevel10k configuration wizard on 2024-01-19 at 00:42 EET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 42599.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# round separators, round heads, round tails, 2 lines, solid, left frame,
# darkest-ornaments, sparse, many icons, fluent, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%002F• '
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR="%k%F{green}\uE0B4%k \uE0B6"
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR="%k%F{green}\uE0B4%k \uE0B6"
